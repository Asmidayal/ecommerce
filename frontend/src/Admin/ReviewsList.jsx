...
import { fetchAdminProducts, fetchProductReviews } from '../features/admin/adminSlice'
import { toast } from 'react-toastify'
import { removeErrors } from '../features/admin/adminSlice'
import Loader from '../Components/Loader'
import { useState } from 'react'
import { deleteReview } from '../features/admin/adminSlice'
...
useEffect(() => {
  ...
  if (success) {
    ...
    navigate('/admin/products'); // Navigate to the products page after successful deletion
        ...
        <tr key={product._id}>
          ...
          <td>
            {product.numOfReviews > 0 &&  (
              <button className="action-btn" onClick={() =>handleViewReviews(product._id)}>View Reviews</button>
            )}
          </td>
        </tr>
      ))}
